...
//
//   const creator = Convert.toCreator(json);
//
...
var Convert = /** @class */ (function () {
    ...
    Convert.toCreator = function (json) {
        return cast(JSON.parse(json), a(r("Creator")));
    };
    Convert.creatorToJson = function (value) {
        return JSON.stringify(uncast(value, a(r("Creator"))), null, 2);
    };
    return Convert;
}());
...
var typeMap = {
    "Creator": o([
        ...
        { json: "c_id", js: "c_id", typ: 0 },
        { json: "p_name", js: "p_name", typ: "" },
        { json: "p_url", js: "p_url", typ: "" },
        { json: "p_categories", js: "p_categories", typ: "" },
